...
function showCongrat() {
  ...
  imgBlock.style.width = '80%';
  imgBlock.style.maxWidth='500px';
  imgBlock.style.margin = '15px auto 0';
...
btn.addEventListener('click', showCongrat);

function showCongratText() {
class TextScramble {
   constructor(el) {
      this.el = el;
